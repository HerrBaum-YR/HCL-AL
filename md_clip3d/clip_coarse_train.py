...
def train(config_file):
    ...
    if cfg.loss.name == 'Clip':
        ...
        assert 'HardNegSample' in cfg.net.name, 'The network architecture does not support computing the ClipHardNegSample loss.'
    ...
    # training data set
    train_data_loader, len_data_set = generate_coarse_training_data_set(cfg)
